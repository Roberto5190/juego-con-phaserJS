class SceneLoad1 extends Phaser.Scene {
    constructor() {
        super({ key: 'SceneLoad1' });
    }
    ...
    create() {
         ...
         *  Fondo
         */
        this.fondoLoad = this.add.image(0, 0, 'fondo_load').setOrigin(0, 0);
        this.tweens.add({
        ...
        this.placaMetro = this.add.image(0, 300, 'placa_metro').setOrigin(0, 0);
        this.tweens.add({
            targets: this.placaMetro,
            y: -200,
            duration: 3000,
            ease: 'Power2',
            onComplete: () => {
